...
def analysis_upload_page():
    st.title("Sentiment Analysis", help="Menampilkan sentiment analysis dengan file csv yang telah diberi label.")
    st.caption("Silakan upload file csv hasil scraping yang telah diberi label.")
    # st.divider()
    st.write("")
